export const environment = {
  ...
  awsCognitorRedirectSignOut: 'https://localhost:4201',
  ...
  // LINKEDIN_API_KEY:"778loa8yp06owl",
  LINKEDIN_API_KEY: "86swphx1hv352j",//By Client
  LINKEDIN_REDIRECT_URL: "http://localhost:4201/login/redirect",
